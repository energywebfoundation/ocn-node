...
class CredentialsServiceTest {
    ...
    init {
        ...
        credentialsService = CredentialsService(walletRepo, registry)
    }


    @Test
    fun `init credentials`() {
        assertThat(credentialsService.credentials.address).isEqualTo(address.toLowerCase())
    }
    ...
    fun toByteArray() {
        ...
        val (r, s, v) = credentialsService.toByteArray(sig)
    ...
    fun sign() {
        ...
        val sig = credentialsService.sign(jsonStringBody)
    ...
    fun `verifyRequest silently succeeds`() {
        ...
        credentialsService.verify(jsonStringBody, sig, BasicRole("XXX", "DE"))
    }
