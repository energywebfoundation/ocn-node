...
data class PermissionsMatcherTestCase(val request: BasicRequestType, val permission: OcnServicePermission, val expected: Boolean)
    ...
    private fun permissionsTestSources(): Stream<Arguments> {
        return Stream.of(
                Arguments.of(PermissionsMatcherTestCase(
                        ...
                        permission = OcnServicePermission.FORWARD_ALL,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.CHARGING_PROFILES, InterfaceRole.RECEIVER),
                        permission = OcnServicePermission.FORWARD_ALL_RECEIVER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.LOCATIONS, InterfaceRole.SENDER),
                        permission = OcnServicePermission.FORWARD_MODULE_LOCATIONS_SENDER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        ...
                        permission = OcnServicePermission.FORWARD_MODULE_SESSIONS_SENDER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.SESSIONS, InterfaceRole.RECEIVER),
                        permission = OcnServicePermission.FORWARD_MODULE_SESSIONS_RECEIVER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.SESSIONS, InterfaceRole.SENDER),
                        permission = OcnServicePermission.FORWARD_MODULE_SESSIONS_RECEIVER,
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        ...
                        permission = OcnServicePermission.FORWARD_MODULE_CDRS_SENDER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.CDRS, InterfaceRole.RECEIVER),
                        permission = OcnServicePermission.FORWARD_MODULE_CDRS_RECEIVER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.CDRS, InterfaceRole.SENDER),
                        permission = OcnServicePermission.FORWARD_MODULE_CDRS_RECEIVER,
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.TARIFFS, InterfaceRole.RECEIVER),
                        permission = OcnServicePermission.FORWARD_MODULE_TARIFFS_RECEIVER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.TARIFFS, InterfaceRole.SENDER),
                        permission = OcnServicePermission.FORWARD_MODULE_TARIFFS_RECEIVER,
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        ...
                        permission = OcnServicePermission.FORWARD_MODULE_TOKENS_SENDER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.TOKENS, InterfaceRole.RECEIVER),
                        permission = OcnServicePermission.FORWARD_MODULE_TOKENS_RECEIVER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.TOKENS, InterfaceRole.SENDER),
                        permission = OcnServicePermission.FORWARD_MODULE_TOKENS_RECEIVER,
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.COMMANDS, InterfaceRole.SENDER),
                        permission = OcnServicePermission.FORWARD_MODULE_COMMANDS_SENDER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.COMMANDS, InterfaceRole.RECEIVER),
                        permission = OcnServicePermission.FORWARD_MODULE_COMMANDS_SENDER,
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.COMMANDS, InterfaceRole.RECEIVER),
                        permission = OcnServicePermission.FORWARD_MODULE_COMMANDS_RECEIVER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.COMMANDS, InterfaceRole.SENDER),
                        permission = OcnServicePermission.FORWARD_MODULE_COMMANDS_RECEIVER,
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        ...
                        permission = OcnServicePermission.FORWARD_MODULE_CHARGINGPROFILES_SENDER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.CHARGING_PROFILES, InterfaceRole.RECEIVER),
                        permission = OcnServicePermission.FORWARD_MODULE_CHARGINGPROFILES_SENDER,
                ...
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.CHARGING_PROFILES, InterfaceRole.RECEIVER),
                        permission = OcnServicePermission.FORWARD_MODULE_CHARGINGPROFILES_RECEIVER,
                        expected = true)),
                Arguments.of(PermissionsMatcherTestCase(
                        request = BasicRequestType(ModuleID.CHARGING_PROFILES, InterfaceRole.SENDER),
                        permission = OcnServicePermission.FORWARD_MODULE_CHARGINGPROFILES_RECEIVER,
